...
\section{\sc \lsstyle work}
    ...
    \textit{Software Engineer}\hfill C++
    \vspace{0.5em}\\
    Context fusion for autonomous vehicles.
    ...
    \vspace{0.5em}
    \begin{itemize}
        \item Developed automatic single-shot monocular camera to sports field calibration
