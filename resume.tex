...
\section{\sc \lsstyle work}
    \href{https://tesla.com/ai}{\textbf{Tesla}}, Palo Alto, CA\hfill \textsc{\bfseries\lsstyle 2021-10 -- present}\\
    \textit{Senior Software Engineer --- Autopilot}\hfill C++, Python
    \vspace{0.5em}
    \begin{itemize}
        \item Multi-trip surface reconstruction; simultaneous localization and mapping (\textsc{slam});
    ...
    \begin{itemize}
        ...
        \item Deep learning lidar feature extraction; spline-based continuous-time SE(3) trajectory optimizer;
